...
### TODO:
1. This example runs on the cpu, we want the inference to use NPU  
2. This example is in c++, we want to use android Activity to call the inference
3. This example did not read png, it just used image data generated by convert.py below  
   We at last want it read from rtsp camera
